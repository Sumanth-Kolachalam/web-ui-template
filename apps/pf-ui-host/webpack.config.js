  ...
  return {
    ...
    plugins: [
      new ModuleFederationPlugin({
        ...
        remotes: {
          UIComponents: isServer ? `UIComponents@/web/boilerplate/remoteEntry.js` :"UIComponents@http://localhost:8081/remoteEntry.js",
          Dashboard: isServer ? `Dashboard@/web/boilerplate/remoteEntry.js` :"Dashboard@http://localhost:8082/remoteEntry.js"
